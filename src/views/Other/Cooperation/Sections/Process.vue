...
<template>
  <div class="process">
    <div class="process-box">
      ...
      <a href="#">聯絡我們</a>
      <n-space>
        <n-button type="warning" size="large" data-bs-toggle="modal" data-bs-target="#CooperationRegister">立即註冊</n-button>
      </n-space>
    </div>
                ...
                <div class="card z-index-0 fadeIn3 fadeInBottom">
                  ...
                  <div class="card-body">
                    <form role="form" class="text-start">
                      ...
                      <div class="input-group input-group-outline my-3">
                        <label class="form-label" data-bs-toggle="modal">電話</label><!--v-if--><input id="phone"
                          type="phone" class="form-control form-control-md" placeholder="" isrequired="true" />
                      </div>
