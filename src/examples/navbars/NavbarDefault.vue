      ...
      >
        ...
        <ul class="navbar-nav d-lg-block">
          <li class="nav-item dropdown dropdown-hover">
            ...
            <!-- 沒登入時選單 -->
            <div
              v-if="!CustomerStore.loggedIn && !Suppliersstore.loggedIn"
              id="dropdown"
